...
import com.xiudun.mapper.ContactDimension;
import com.xiudun.mapper.DateDimension;
 ...
 */
public class DimensionConverterImpl  {
    //Logger
    ...
    public int getDimensionID(Object dimension) {
        ...
        String[] sqls = null;
        if (dimension instanceof DateDimension) {//通话年月日
            sqls = getDateDimensionSQL();
        } else if (dimension instanceof ContactDimension) {//联系人、联系电话
     ...
     * @return
     */
    private int execSQL(Connection conn, String[] sqls, Object dimension) {
     ...
     * @param dimension
     */
    private void setArguments(PreparedStatement preparedStatement, Object dimension) {
        int i = 0;
        try {
     ...
     * @return
     */
    private String genCacheKey(Object dimension) {
